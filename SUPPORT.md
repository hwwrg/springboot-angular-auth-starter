...
- Relevant logs (remove any secrets before pasting)
- Environment details (OS, Java version, Node version, Docker version)
...
Do **not** open a public issue for suspected security vulnerabilities. Follow [SECURITY.md](./SECURITY.md) instead.
